...
export default function AnniversaryRomanceTemplate() {
  const [showCoupleQR, setShowCoupleQR] = useState(false);
  const [showInvitation, setShowInvitation] = useState(false);

  // Colors - Anniversary Romance theme
  const primaryColor = "#E91E63"; // Deep pink
  const secondaryColor = "#C2185B"; // Darker pink
  const romanticPink = "#F8BBD0"; // Light pink
  const romanticRed = "#E91E63"; // Romantic red
  const accentColor = "#FFB6C1"; // Light pink accent
  const textColor = "#ffffff"; // White for main text
  const highlightColor = "#FF69B4"; // Bright pink highlight
  ...
  // Images
  const backgroundImage = "/images/assets/anniversary-romance/anniversary-romance.png"; // Main background
  const decorativeTopLeft = "/images/assets/anniversary-romance/frame-top-left.png";
  const decorativeTopRight = "/images/assets/anniversary-romance/frame-top-right.png";
  const decorativeBottomLeft = "/images/assets/anniversary-romance/frame-bottom-left.png";
  const decorativeBottomRight = "/images/assets/anniversary-romance/frame-bottom-right.png";
  const decorativeBorder = "/images/assets/anniversary-romance/frame-bottom.png";
  const heartsPattern = "/images/assets/hearts-pattern.png"; // Hearts pattern overlay
  const galleryImages = [
    "/images/gallery1.png",
    "/images/gallery2.png",
    "/images/gallery3.png",
  ...
  const frameBtn = "/images/assets/anniversary-romance/frame-btn.png";
  const frameGuestName = "/images/assets/anniversary-romance/frame-guest-name.png";
    ...
    >
      ...
      {heartsPattern && (
        <motion.div
          ...
          style={{
            backgroundImage: `url(${heartsPattern})`,
