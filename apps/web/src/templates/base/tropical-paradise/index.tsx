...
export default function TropicalParadiseTemplate() {
  const [showCoupleQR, setShowCoupleQR] = useState(false);
  const [showInvitation, setShowInvitation] = useState(false);

  // Colors - Tropical Paradise theme
  const primaryColor = "#00BCD4"; // Cyan
  const tropicalBlue = "#00ACC1"; // Darker cyan
  const tropicalGreen = "#4CAF50"; // Green
  const textColor = "#ffffff"; // White for main text
  const highlightColor = "#26A69A"; // Teal highlight
  ...
  // Images
  const backgroundImage = "/images/assets/tropical-paradise/tropical-paradise.png"; // Main background
  const decorativeTopLeft = "/images/assets/tropical-paradise/frame-top-left.png";
  const decorativeTopRight = "/images/assets/tropical-paradise/frame-top-right.png";
  const decorativeBottomLeft = "/images/assets/tropical-paradise/frame-bottom-left.png";
  const decorativeBottomRight = "/images/assets/tropical-paradise/frame-bottom-right.png";
  const decorativeBorder = "/images/assets/tropical-paradise/frame-bottom.png";
  const palmLeaves = "/images/assets/palm-leaves.png"; // Palm leaves pattern
  const galleryImages = [
    "/images/gallery1.png",
    "/images/gallery2.png",
    "/images/gallery3.png",
  ...
  const frameBtn = "/images/assets/tropical-paradise/frame-btn.png";
  const frameGuestName = "/images/assets/tropical-paradise/frame-guest-name.png";
    ...
    <section
      ...
      style={{
        backgroundImage: backgroundImage
          ? `url(${backgroundImage})`
          : `linear-gradient(135deg, ${tropicalBlue} 0%, ${tropicalGreen} 50%, ${primaryColor} 100%)`,
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span style={{ color: tropicalGreen }}>
