...
export default function BirthdayCelebrationTemplate() {
  const [showCoupleQR, setShowCoupleQR] = useState(false);
  const [showInvitation, setShowInvitation] = useState(false);

  // Colors - Birthday Celebration theme
  const primaryColor = "#FF6B6B"; // Red
  const secondaryColor = "#4ECDC4"; // Teal
  const accentColor = "#FFE66D"; // Yellow
  const celebrationColor = "#FF8B94"; // Pink
  const textColor = "#ffffff"; // White for main text
  const highlightColor = "#FFD93D"; // Bright yellow highlight
  ...
  // Images
  const backgroundImage = "/images/assets/birthday-celebration/birthday-celebration.png"; // Main background
  const decorativeTopLeft = "/images/assets/birthday-celebration/frame-top-left.png";
  const decorativeTopRight = "/images/assets/birthday-celebration/frame-top-right.png";
  const decorativeBottomLeft = "/images/assets/birthday-celebration/frame-bottom-left.png";
  const decorativeBottomRight = "/images/assets/birthday-celebration/frame-bottom-right.png";
  const decorativeBorder = "/images/assets/birthday-celebration/frame-bottom.png";
  const confettiPattern = "/images/assets/confetti-pattern.png"; // Confetti pattern overlay
  const galleryImages = [
    "/images/gallery1.png",
    "/images/gallery2.png",
    "/images/gallery3.png",
  ...
  const frameBtn = "/images/assets/birthday-celebration/frame-btn.png";
  const frameGuestName = "/images/assets/birthday-celebration/frame-guest-name.png";
    ...
    >
      ...
      {confettiPattern && (
        <motion.div
          ...
          style={{
            backgroundImage: `url(${confettiPattern})`,
