...
export default function ClassicGoldTemplate() {
  ...
  const accentColor = "#F4D03F"; // Light gold
  const goldColor = "#FFD700"; // Bright gold
  const textColor = "#ffffff"; // White for main text
  const highlightColor = "#FFC107"; // Amber gold highlight
  ...
  // Images
  const backgroundImage = "/images/assets/classic-gold/classic-gold.png"; // Main background
  const decorativeTopLeft = "/images/assets/classic-gold/frame-top-left.png";
  const decorativeTopRight = "/images/assets/classic-gold/frame-top-right.png";
  const decorativeBottomLeft = "/images/assets/classic-gold/frame-bottom-left.png";
  const decorativeBottomRight = "/images/assets/classic-gold/frame-bottom-right.png";
  const decorativeBorder = "/images/assets/classic-gold/frame-bottom.png";
  const goldPattern = "/images/assets/gold-pattern.png"; // Gold pattern overlay
  const galleryImages = [
    "/images/gallery1.png",
    "/images/gallery2.png",
    "/images/gallery3.png",
  ...
  const frameBtn = "/images/assets/classic-gold/frame-btn.png";
  const frameGuestName = "/images/assets/classic-gold/frame-guest-name.png";
    ...
    <section
      ...
      style={{
        backgroundImage: backgroundImage
          ? `url(${backgroundImage})`
          : `linear-gradient(135deg, ${secondaryColor} 0%, ${primaryColor} 50%, ${secondaryColor} 100%)`,
